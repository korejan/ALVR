...
alvr::libav::libav()
{
	LOAD_LIB(avutil, LIBAVUTIL_VERSION_MAJOR)
	LOAD_LIB(avcodec, LIBAVCODEC_VERSION_MAJOR)
	LOAD_LIB(swscale, LIBSWSCALE_VERSION_MAJOR)
	LOAD_LIB(avfilter, LIBAVFILTER_VERSION_MAJOR)
}
#undef str
